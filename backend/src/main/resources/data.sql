...
INSERT INTO logs (id, log_date, weight, calories, protein)
VALUES(1, '2021-02-07', 150.5, 800, 100);

INSERT INTO logs (id, log_date, weight, calories, protein)
VALUES(2, '2021-01-31', 170.5, 450, 100);

INSERT INTO logs (id, log_date, weight, calories, protein)
VALUES(3, '2020-12-31', 130.5, 1500, 50);
